...
<Callout type="info" emoji="✨">
**왜 zustand?** React Context API보다 더 간결한 코드로 작성할 수 있어요. Context API의 불필요한 리렌더링 문제도 해결됩니다. 성능 비교와 올바른 사용법이 궁금하다면 [Zustand vs Context API: 올바른 선택과 사용법](../performance/zustand-vs-context-performance)을 확인해보세요!
</Callout>
