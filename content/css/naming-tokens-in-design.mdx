...
const buttonVariants = cva(
  ...
  'inline-flex items-center justify-center rounded-md',
  {
    variants: { // [!code focus]
      variant: { // [!code focus]
        primary: 'bg-primary text-primary-foreground', // [!code focus]
        secondary: 'bg-secondary text-secondary-foreground', // [!code focus]
        outline: 'border border-input bg-background', // [!code focus]
      }, // [!code focus]
      size: { // [!code focus]
        sm: 'h-9 px-3', // [!code focus]
        md: 'h-10 px-4', // [!code focus]
        lg: 'h-11 px-8', // [!code focus]
      }, // [!code focus]
    }, // [!code focus]
