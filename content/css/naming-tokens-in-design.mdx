...
summary: '의미 있는 디자인 토큰으로 일관성 유지와 프로젝트 확장성 향상'
description: '디자인 토큰은 디자인 시스템의 최소 단위로, 일관성을 유지하고 프로젝트를 확장하는 데 도움이 됩니다. 이 글에선 의미 있는 디자인 토큰을 설계하기 위한 방법을 소개합니다.'
category: 'css'
...
![level](/images/naming-tokens-in-design/first.webp)
...
![base](/images/naming-tokens-in-design/base.webp)
...
![modifier](/images/naming-tokens-in-design/modifier.webp)
...
![object](/images/naming-tokens-in-design/object.webp)
...
![중첩된 요소가 포함된 인풋 요소](/images/naming-tokens-in-design/input.svg)
...
![namespace](/images/naming-tokens-in-design/namespace.webp)
