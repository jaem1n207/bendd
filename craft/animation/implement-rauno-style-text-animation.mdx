...
![rauno-projects-animation](/images/craft/implement-rauno-style-text-animation/rauno-projects-animation.gif)
...
<video width="100%" controls preload="metadata" loop muted playsInline>
  ...
  />
  <img
    src="/images/craft/implement-rauno-style-text-animation/new-animated-text.gif"
    alt=""
  />
</video>
