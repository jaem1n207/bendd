      ...
      <main>
        <div className="bd-mt-16 sm:bd-mt-24">
          ...
          <Typography variant="p" affects="muted" asChild>
            <p className="bd-break-keep">
              사소해 보이는 애니메이션과 마이크로 인터랙션이 유려한 사용자
              경험의 핵심이 되는 순간을 만듭니다.
              <br />
              ...
              요소입니다.
              <br />
              기술을 통해 사용자의 예측 가능하고 즐거운 경험을 설계하며,
              디테일에 대한 깊은 고민이 혁신적인 사용자 경험으로 이어진다고
              생각합니다.
            </p>
          </Typography>
        </div>
        ...
        <div className="bd-mt-16 sm:bd-mt-24">
          ...
          >
            ...
            <span className="bd-text-gray-950">
        ...
        <div className="bd-mt-16 sm:bd-mt-24">
          ...
          >
            ...
            <span className="bd-break-keep bd-text-gray-950">
              13.1K 스타의 Nextra에서 검색어에 연속된 공백이 포함될 때 발생하는
