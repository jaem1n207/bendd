...
export const CopyToClipboard = ({
  ...
  return (
    <Button
      ...
      className={cn('group hover:[--active:1]', className)}
      {...props}
      data-copied={isCopied}
    >
      <ClipBoard className="pointer-events-none size-5" />
...
function ClipBoard({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        className={cn(
          'fill-[var(--bg)] group-hover:fill-[var(--control)] group-focus-visible:fill-[var(--control)]',
          'rotate-[5deg] group-data-[copied=true]:rotate-0',
          'translate-x-[calc(20%+(var(--active,0)*-5%))] translate-y-[-8%] group-data-[copied=true]:translate-x-0 group-data-[copied=true]:translate-y-0',
          'transition-[transform,rotate] duration-200'
        )}
      ...
      <path
        className={cn(
          'fill-[var(--bg)] group-hover:fill-[var(--control)] group-focus-visible:fill-[var(--control)]',
          'rotate-[-5deg] group-data-[copied=true]:rotate-0',
          'translate-x-[calc(-50%+(var(--active,0)*25%))] translate-y-[calc(25%-(var(--active,0)*10%))] group-data-[copied=true]:translate-x-0 group-data-[copied=true]:translate-y-0',
          'transition-[transform,rotate] duration-200'
        )}
      ...
      <path
        className={cn(
          ...
          'transition-[stroke-dashoffset] duration-200 group-data-[copied=true]:delay-200'
        )}
        pathLength="1"
