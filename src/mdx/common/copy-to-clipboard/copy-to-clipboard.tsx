...
function ClipBoard({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path
        className={cn(
          'bd:fill-(var(--bg)) group-bd:hover:fill-(var(--control)) group-bd:focus-visible:fill-(var(--control))',
          'bd:rotate-[5deg] bd:group-data-[copied=true]:rotate-0',
          'bd:translate-x-(calc(20%+(var(--active,0)*-5%))) bd:translate-y-(-8%) bd:group-data-[copied=true]:translate-x-0 bd:group-data-[copied=true]:translate-y-0',
      ...
      <path
        className={cn(
          'bd:fill-(var(--bg)) group-bd:hover:fill-(var(--control)) group-bd:focus-visible:fill-(var(--control))',
          'bd:rotate-[-5deg] bd:group-data-[copied=true]:rotate-0',
          'bd:translate-x-(calc(-50%+(var(--active,0)*25%))) bd:translate-y-(calc(25%-(var(--active,0)*10%))) bd:group-data-[copied=true]:translate-x-0 bd:group-data-[copied=true]:translate-y-0',
          'bd:transition-[transform,rotate] bd:duration-200'
        )}
      ...
      <path
        className={cn(
          ...
          'bd:transition-[stroke-dashoffset] bd:duration-200 bd:group-data-[copied=true]:delay-200'
        )}
        pathLength="1"
