...
export function ArticleList() {
  ...
  return (
    <div className="bd:relative bd:mx-auto bd:my-0 bd:mt-8 bd:max-w-4xl bd:space-y-1 bd:overflow-y-auto bd:overflow-x-hidden bd:px-2 bd:pb-28 bd:pt-10 bd:sm:px-6 bd:sm:py-32">
